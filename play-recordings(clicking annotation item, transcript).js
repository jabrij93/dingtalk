...
// ------------------------------------------------------------
// TOTAL AUDIO DURATION TRACKER
// ------------------------------------------------------------
//
// This stores the total amount of audio that has actually
// finished playing during THIS program run.
//
// It is deliberately NOT loaded from batch-results.json.
//
// Every time an audio finishes successfully, its duration is
// added here.
//
// Example:
//
...
// ============================================================
// ADD COMPLETED AUDIO DURATION
// ============================================================
//
// This function is called ONLY after an audio has actually
// reached the end.
//
// Therefore the total represents audio that has genuinely
// been played, not audio merely loaded or attempted.
//
// ============================================================
      ...
      try {
        ...
        if (
          ...
          if (
            ...
            // ==================================================
            // LIVE TOTAL AUDIO DURATION
            // ==================================================
            //
            // This is printed BEFORE the current task starts.
            //
            // Therefore it represents the total amount of audio
            // that has already been successfully played so far.
            //
            // The current task is NOT included yet.
            //
            // ==================================================
...
// ============================================================
// OPEN ANNOTATION ITEM AND CLICK ANNOTATION RESULT
// ============================================================
...
// IMPORTANT:
//
// When the audio reaches the end, its actual duration is added
// to totalAudioPlayedSeconds.
//
// This happens immediately when the task finishes.
//
// ============================================================
...
async function waitForPlaybackToFinish(
  ...
  while (
    ...
    if (
      ...
      // ------------------------------------------------------
      // ADD THE ACTUAL AUDIO DURATION TO THE RUNNING TOTAL.
      // ------------------------------------------------------
...
async function processAllTasks(
  ...
  // ----------------------------------------------------------
  // TOTAL AUDIO STARTS AT 0 FOR EACH PROGRAM RUN.
  // ----------------------------------------------------------
  ...
  if (
    ...
    console.log(
      `⚠️ ${failed} recording attempt(s) failed.`
    );
  }
}
...
async function main() {
  ...
  try {
    ...
    // --------------------------------------------------------
    // RESET TOTAL FOR THIS PROGRAM RUN
    // --------------------------------------------------------
